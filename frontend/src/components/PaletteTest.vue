<template>
    ...
    >
      ...
      <div class="palette">
        ...
        <div v-if="!isSemanticColorMode" class="color-box" v-for="(color, name) in defaultColors" :key="name">
        ...
        <div v-if="isSemanticColorMode" class="color-box" v-for="(color, name) in semanticColors" :key="name">
          <div :style="{ backgroundColor: color }" class="color-display"></div>
          <p class="color-name">{{ name }}</p>
          <p class="color-code">{{ color }}</p>
        </div>
