  ...
  <div class="min-h-screen min-w-screen flex items-center justify-center pt-4 pb-4" :style="{ background: 'linear-gradient(135deg, var(--primary-blue) 0%, var(--blue-dark) 100%)' }">
    <div class="w-full max-w-md bg-[var(--primary-white)] rounded-xl shadow-xl overflow-hidden relative mx-4">
      ...
      <div class="pt-8 pb-6 text-center">
        ...
        <p class="text-[var(--neutral-800)]">Create your account</p>
      </div>
      
      <!-- Error Message -->
      <div v-if="errorMessage" class="bg-[var(--neutral-300)] border-l-4 border-[var(--primary-blue)] text-[var(--neutral-800)] px-4 py-3 rounded-md relative mx-6 mb-3">
        ...
        <form @submit.prevent="handleRegister" class="space-y-6 text-[var(--neutral-800)]">
          ...
          <div class="!mb-2">
            ...
            <input 
              ...
              id="username" 
              v-model="username" 
              class="w-full px-4 py-3 bg-[var(--neutral-200)] border border-[var(--neutral-400)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-blue)] text-[var(--neutral-800)]"
          ...
          <div class="!mb-2">
            <label for="email" class="block text-base font-medium mb-2" :style="{ color: 'var(--primary-blue)' }">Email</label>
            <input 
              type="email" 
              id="email" 
              v-model="email" 
          ...
          <div class="!mb-2">
            <label for="password" class="block text-base font-medium mb-2" :style="{ color: 'var(--primary-blue)' }">Password</label>
            <div class="relative">
              <input 
          ...
          <div class="!mb-2">
            <label for="confirmPassword" class="block text-base font-medium mb-2" :style="{ color: 'var(--primary-blue)' }">Confirm Password</label>
            <div class="relative">
              <input 
              ...
              <button 
                ...
                class="absolute right-3 top-1/2 transform -translate-y-1/2 text-[var(--neutral-800)] cursor-pointer"
              >
                <svg v-if="showConfirmPassword" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path>
                </svg>
                <svg v-else class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
          ...
          <div class="!mb-5">
            <label for="role" class="block text-base font-medium mb-2" :style="{ color: 'var(--primary-blue)' }">Role</label>
            <select 
              id="role"
              v-model="role" 
              class="w-full px-4 py-3 bg-[var(--neutral-200)] border border-[var(--neutral-400)] rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary-blue)] text-[var(--neutral-800)] appearance-none cursor-pointer"
          ...
          <button 
            type="submit" 
            class="w-full py-3 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors text-lg font-medium flex justify-center items-center text-[var(--primary-white)] cursor-pointer"
            :style="{ 
            ...
            :disabled="isLoading"
          >
            <svg v-if="isLoading" class="animate-spin -ml-1 !mr-3 h-5 w-5 text-[var(--primary-white)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div class="h-2 mt-6" :style="{ background: 'linear-gradient(90deg, var(--primary-green) 0%, var(--green-light) 100%)' }"></div>
    </div>
  </div>
</template>
