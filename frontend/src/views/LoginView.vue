  ...
  <div class="h-screen w-screen flex items-center justify-center" :style="{ background: 'linear-gradient(135deg, var(--primary-blue) 0%, var(--blue-dark) 100%)' }">
    <div class="w-full max-w-md bg-[var(--primary-white)] rounded-xl shadow-xl overflow-hidden relative mx-4">
      ...
      <div class="px-8 py-6 space-y-6">
        <!-- Error Alert -->
        <div v-if="loginError" class="bg-[var(--neutral-300)] border-l-4 border-[var(--primary-blue)] text-[var(--neutral-800)] px-4 py-3 rounded-md relative mb-6">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6 text-[var(--neutral-800)]">
          <div>
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              <label for="password" class="block text-base font-medium" :style="{ color: 'var(--primary-blue)' }">Password</label>
              <a href="#" class="text-sm hover:text-[var(--blue-dark)]" :style="{ color: 'var(--primary-blue)' }">Forgot password?</a>
            </div>
            <div class="relative">
              <input 
          ...
          <div class="flex items-center">
            <input 
              type="checkbox" 
              id="remember" 
              class="h-5 w-5 focus:ring-[var(--primary-blue)] border-[var(--neutral-400)] rounded cursor-pointer" 
              :style="{ color: 'var(--primary-blue)' }"
            />
            <label for="remember" class="!ml-3 block text-base text-[var(--neutral-800)]">Remember me</label>
          </div>
          ...
          <button 
            ...
            :disabled="isLoading"
          >
            <svg v-if="isLoading" class="animate-spin -ml-1 mr-2 h-5 w-5 text-[var(--primary-white)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="mt-8 space-y-6">
          ...
          <div class="mt-6">
            <button 
              ...
              class="w-full flex justify-center items-center py-3 px-4 rounded-md shadow-sm text-sm font-medium text-[var(--primary-white)] cursor-pointer"
              :style="{ 
